...
<p><code>(def mapa {:nome "Guilherme" :endereco {:cidade "São Paulo" :rua "Rua Sete de Abril"}})</code></p>

<p>Outra forma de criar mapas é através da função <b>hash-map</b>: </p>

<p><code>(def usuario (hash-map :nome "Guilherme" :cidade "São Paulo"))</code></p>
...
<br/>
<div class="message">
<p><i>Keywors são geralmente utilizadas como chaves em mapas no Clojure.</i></p>
</div>
...
<p><code>(set [2 2 5 6 5 1 1])</code><br/><i>=> #{1 6 2 5}</i></p>
